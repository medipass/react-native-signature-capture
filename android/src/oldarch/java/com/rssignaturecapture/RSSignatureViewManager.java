...
public class RSSignatureViewManager
    extends ViewGroupManager<RSSignatureCaptureMainView>
{

    public static final String PROPS_SAVE_IMAGE_FILE =
    ...
    public void setSaveImageFileInExtStorage(
        RSSignatureCaptureMainView view,
        @Nullable Boolean saveFile
    ) {
    ...
    public void setPropsShowNativeButtons(
        RSSignatureCaptureMainView view,
        @Nullable Boolean showNativeButtons
    ) {
    ...
    public void setPropsMinStrokeWidth(
        RSSignatureCaptureMainView view,
        @Nullable int minStrokeWidth
    ) {
    ...
    public void setPropsMaxStrokeWidth(
        RSSignatureCaptureMainView view,
        @Nullable int maxStrokeWidth
    ) {
    ...
    public void setPropsStrokeColor(
        RSSignatureCaptureMainView view,
    ...
    public void setPropsBackgroundColor(
        RSSignatureCaptureMainView view,
        @Nullable String color
    ) {
        int parsed;
    ...
    @Override
    public RSSignatureCaptureMainView createViewInstance(
        ThemedReactContext context
    ) {
        Log.d("React", " View manager createViewInstance:");
        return new RSSignatureCaptureMainView(
            context,
            mContextModule.getActivity()
        );
    }
